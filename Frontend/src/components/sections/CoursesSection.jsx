...
import { Scissors, Shirt, Ruler, Sparkles, BookOpen } from 'lucide-react'
import Card from '../ui/Card'
import SectionHeading from '../ui/SectionHeading'

const courseIconMap = {
  'Basic Sewing Training': Scissors,
  'Fashion Design': Shirt,
  'Pattern Making': Ruler,
  'Bridal & Traditional Wear': Sparkles,
}
              ...
              >
                <div className="flex items-start gap-2.5">
                  <span className="mt-0.5 inline-flex h-6 w-6 shrink-0 items-center justify-center rounded-full text-[10px] font-bold text-[#cc5b2b]">
                    <CourseIcon
                      size={14}
                      className="text-[#FB93BE] h-8 w-8 font-bold"
                      aria-hidden="true"
                    />
                  </span>
                  <div>
                ...
                <div className="mt-3 mx-auto flex flex-wrap items-center gap-2 sm:mt-4 sm:gap-2.5">
                  ...
                  <span className="rounded-md border border-[#d0d2d8] bg-[#e9c8d5] px-2.5 py-1 text-[11px] font-semibold text-[#82264b]">
                    {course.duration}
                  </span>
                  <a
                    href="/register"
