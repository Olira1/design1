/*
  ...
  ---------------------
  This file stores short selling points for the About and Why Choose Us sections.
*/
...
/*
  The icon field is a simple text key for now.
  In Step 3 or later, UI components can decide how to display each icon.
*/
